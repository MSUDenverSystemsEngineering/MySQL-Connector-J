...
function Install-ADTDeployment
{
    ...
    If ((Test-Path "$envCommonDocuments\mysql-connector-j-9.3.0") -eq $false) {
        Copy-ADTFile -Path "$($adtSession.DirFiles)\mysql-connector-j-9.3.0" -Destination "$envCommonDocuments" -Recurse
    }
...
function Uninstall-ADTDeployment
{
    ...
    If ((Test-Path "$envCommonDocuments\mysql-connector-j-9.3.0") -eq $true) {
        Remove-ADTFile -Path "$envCommonDocuments\mysql-connector-j-9.3.0" -Recurse
    }
