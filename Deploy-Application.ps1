...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		If ((Test-Path "$envCommonDocuments\mysql-connector-java-8.0.30") -eq $false) {
			Copy-File -Path "$dirFiles\mysql-connector-java-8.0.30" -Destination "$envCommonDocuments" -Recurse
		}
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		If ((Test-Path "$envCommonDocuments\mysql-connector-java-8.0.30") -eq $true) {
			Remove-File -Path "$envCommonDocuments\mysql-connector-java-8.0.30" -Recurse
		}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjFyRahdquxG/vjBoENujdLQA
# vxigghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFFX5fHJ006HKVgtTlArEmya6KmF3MA0GCSqGSIb3DQEBAQUABIIBgB7oJ8U/
# jwfF1eLR9tgso74nzlNhyFW2dcUrJSF1TUAveCNar3Weeis9e16Hw3LYUWDOEpeR
# 7NwQn9CCwR5dDFi3l4WV9drPOOHreY3Qa6ekVd2jzW4IIO0Da+bMJqCvTFz7zFea
# EIE+90tVZtLsUaFbX+CeS/WncuIIXlB8OHXWZCkCD9QuRdf+78jkwZsHoj65dDaE
# OOOIzpKXXAv4TGX7igjzWz+laSgq38bEDALQv5z8hnz1JV6xtSVev+/IyEiGw40j
# eyfZSVQAxekJS9TiEVTxBi7WalU2cgAs0DztM9mxCGHHslXTNdNHyXcnVLavxA6w
# O/ojvZkPHD5pQqqzHsgjaF/nMg3zHPpr3EmRKgjxHNTWDgEX3Iw28wHRwd/Lo+x/
# vd/O9qdFOxCWorQQv0jJFw1mzHUDB7WSwx5dQtZdzMh/XF9qDFooyGa9e2JM3hoF
# 02USYA/WHPzLK5We7TVJo0lJjbtvzgoRgPLy6t/Pxr67k3L4w0V1F+KDLA==
